...
<!-- LESSON-02 — 2–4 sentences. Connect to the learner's lived experience or to the build payoff later in the course. Tenet 4 (coherence): may name the prior-lesson payoff this lesson builds on — a felt continuation of the journey, NOT a syllabus recap ("in Lesson 3 we covered X"). Keep it inside the felt-pain template. See COURSE-AUTHORING Part 3. -->
...
<!-- LESSON-10 — 2–4 sentences recapping the exercise and connecting it back to the durable AI-coding loop. Tenet 4 (coherence): name what this lesson sets up next — narrative closure, NOT an anxiety-management forward-ref. See COURSE-AUTHORING Part 3. -->
...
- **Tenet 4 — narrative coherence (`docs/COURSE-AUTHORING.md` Part 3):** Honor the module's `## What this module builds` spine. "Why this matters" may build on the prior lesson's payoff; "What you just did" names what this lesson sets up. Setup/closure is narrative — distinct from the anxiety-management forward-refs Part 1's pruning rule deletes. GUIDANCE (human review; no lint).
