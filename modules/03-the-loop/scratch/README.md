...
Module 4 onward is where you'll meet the framework stack. The scratch directory is throwaway: M3 Lesson 4 ends with "you can delete the scratch directory now — your real project starts in Module 4." Don't grow this file into your real project; start fresh.
